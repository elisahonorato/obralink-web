...
export async function generateMetadata(props: IProductsDetailProps) {
  const t = await getTranslations({
    locale: props.params.locale,
    namespace: 'ProductsSlug',
  });
...
const ProductsDetail = (props: IProductsDetailProps) => {
  const t = useTranslations('ProductsSlug');
