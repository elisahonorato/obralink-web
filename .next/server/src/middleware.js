...
exports["default"] = function(r) {
    ...
    return function(r) {
        ...
        const P = o.getNormalizedPathname(r.nextUrl.pathname, s.locales), g = o.getKnownLocaleFromPathname(r.nextUrl.pathname, s.locales), L = null != g;
...
var e = __webpack_require__(256), t = __webpack_require__(137), a = __webpack_require__(174), n = __webpack_require__(142);
function o(e) {
...
var r = o(t);
function l(t, o, l, c) {
    let i, { defaultLocale: u, localeDetection: s, locales: d } = t;
    if (c) {
        const e = n.getLocaleFromPathname(c);
        d.includes(e) && (i = e);
    }
    if (!i && s && l && l.has(a.COOKIE_LOCALE_NAME)) {
        var f;
        const e = null === (f = l.get(a.COOKIE_LOCALE_NAME)) || void 0 === f ? void 0 : f.value;
        e && d.includes(e) && (i = e);
    }
    return !i && s && o && (i = function(t, a, n) {
        let o;
...
function c(e, t, a, o) {
    const { domains: r } = e, c = l(e, t, a, o);
    if (r) {
        const e = function(e, t) {
            var a;
            let o = n.getHost(e);
            if (o = null === (a = o) || void 0 === a ? void 0 : a.replace(/:\d+$/, ""), o && t) return t.find((e)=>e.domain === o);
        }(t, r), a = o && o.startsWith("/".concat(c));
        if (e) return {
            locale: n.isLocaleSupportedOnDomain(c, e) || a ? c : e.defaultLocale,
            domain: e
        };
    }
    return {
...
exports["default"] = function(e, t, a, n) {
    return e.domains ? c(e, t, a, n) : {
        locale: l(e, t, a, n)
    };
};
...
exports.applyBasePath = function(e, t) {
    return a(t + e);
}, exports.formatPathname = o, exports.formatTemplatePathname = function(e, t, r, l) {
    const c = n(t, e);
    let s = "";
    return l && (s = "/".concat(l)), s += o(r, c), s = a(s), s;
}, exports.getBestMatchingDomain = function(e, t, n) {
    let o;
    return e && r(t, e) && (o = e), o || (o = n.find((e)=>e.defaultLocale === t)), o || (o = n.find((e)=>null != e.locales && e.locales.includes(t))), o || null != (null == e ? void 0 : e.locales) || (o = e), o || (o = n.find((e)=>!e.locales)), o;
...
}, exports.getKnownLocaleFromPathname = function(e, n) {
    const o = t(e);
    return n.includes(o) ? o : void 0;
}, exports.getLocaleFromPathname = t, exports.getNormalizedPathname = function(e, t) {
    e.endsWith("/") || (e += "/");
    const n = e.match("^/(".concat(t.join("|"), ")/(.*)"));
    let o = n ? "/" + n[2] : e;
    return "/" !== o && (o = a(o)), o;
}, exports.getPathWithSearch = function(e, t) {
    let n = e;
    return t && (n += t), n;
}, exports.getRouteParams = n, exports.isLocaleSupportedOnDomain = r;
